...
RAM_CORENLP: str = "90G"  # max RAM allocated for parsing using CoreNLP; increase to speed up parsing
PARSE_CHUNK_SIZE: int = 1500 # number of lines in the input file to process uing CoreNLP at once. Increase on workstations with larger RAM (e.g. to 1000 if RAM is 64G)  

# Directory locations
os.environ[
    "CORENLP_HOME"
] = "/export/home/dor/mrajapaksha/Culture_jp/Codes/Measuring-Corporate-Culture-Using-Machine-Learning-master/standford_corenlp/stanford-corenlp-full-2018-10-05"  # location of the CoreNLP models; use / to seperate folders
...
} ## This will be updated after training the word2vec model
